                    ...
                    <div className="cart">
                        <div className="cart__item">
                            ...
                            <div className="cart__content">
                                <h3 className="cart__head">MANGO  PEOPLE  T-SHIRT</h3>
                                <div className="cart__desc">
                                    <p>Prise: <span className="cart__prise">$300</span></p>
                                    <p>Color: Red</p>
                                    <p>Size: XL	</p>
                                    <div className="cart__qty">
                                        <label >Quantity:</label>
                                        <input className="cart__input" type="number" value={quantity} onChange={(e) => setQuantity(e.target.value)} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="cart__item">
                            <img src={require("../img/card7.png")} alt="card3" />
                            <div className="cart__content">
                                <h3 className="cart__head">MANGO  PEOPLE  T-SHIRT</h3>
                                <div className="cart__desc">
                                    <p>Prise: <span className="cart__prise">$300</span></p>
                    ...
                    <div className="order">
                        ...
                        <div className="order__sum">
                            ...
                            <div className="order__total">
                                ...
                                <p className="order__total_sum">$900</p>
                            </div>
